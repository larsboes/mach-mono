...
> **Adapter note:** This is an agent brainstorming reference. The authoritative feature roadmap and plugin specs live in `Plans/PRDs/machNotch.md`.
>
> **Design Principle:** Every feature is a plugin. No vendor lock-in. Data is exportable. APIs are local-first.
>
> Last updated: 2026-05-02
For the authoritative feature roadmap and plugin specs, see `Plans/PRDs/machNotch.md → Phase 16`.
...
3. **Documentation:** Every feature or performance fix must update the relevant PRD under `Plans/PRDs/` and any affected guides or ADRs.
