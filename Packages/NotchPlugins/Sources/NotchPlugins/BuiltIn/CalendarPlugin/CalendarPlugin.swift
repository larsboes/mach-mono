...
@MainActor
@Observable
public final class CalendarPlugin: NotchPlugin, ExportablePlugin {

    // MARK: - NotchPlugin

    public let id = PluginID.calendar
    ...
    public var supportedExportFormats: [ExportFormat] { [.json, .csv, .ical] }
