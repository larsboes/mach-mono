...
@MainActor
public final class PluginSettings: Observable {
    private let pluginId: String
    private let prefix: String

    /// Settings change publisher
    private let changesSubject = PassthroughSubject<String, Never>()
    public var changesPublisher: AnyPublisher<String, Never> {
    ...
    public var showInClosedNotch: Bool {
    ...
    public func get<T: Defaults.Serializable>(_ key: String, default defaultValue: T) -> T {
        let fullKey = makeKey(key, default: defaultValue)
        return Defaults[fullKey]
    }

    /// Set a setting value
    public func set<T: Defaults.Serializable>(_ key: String, value: T) {
    ...
    public func observe<T: Defaults.Serializable>(
        _ key: String,
...
public extension PluginSettings {
