...
public struct QuickShareProvider: Identifiable, Hashable, Sendable {
    public var id: String
    public var supportsRawText: Bool

    public init(id: String, supportsRawText: Bool) {
        self.id = id
        self.supportsRawText = supportsRawText
    }
}
...
public class QuickShareService {
    public var availableProviders: [QuickShareProvider] = []
    public var isPickerOpen = false
    ...
    @MainActor
    public func icon(for providerId: String, size: CGFloat) -> NSImage? {
    ...
    // MARK: - File Picker
    @MainActor
    public func showFilePicker(for provider: QuickShareProvider, from view: NSView?) async {
