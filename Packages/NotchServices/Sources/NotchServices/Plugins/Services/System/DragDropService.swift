...
@MainActor
public final class DragDropService: DragDropServiceProtocol {

    // MARK: - Callbacks

    public var onDragEntersNotchRegion: (() -> Void)?
    public var onDragExitsNotchRegion: (() -> Void)?
    ...
    public func updateNotchRegion(_ region: CGRect) {
