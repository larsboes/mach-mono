...
@MainActor
@Observable
public final class FaceService: FaceServiceProtocol {
    // MARK: - Properties

    public var eyeOffset: CGSize = .zero
    public var isSleepy: Bool = false
    ...
    public init(settings: any MediaSettings) {
