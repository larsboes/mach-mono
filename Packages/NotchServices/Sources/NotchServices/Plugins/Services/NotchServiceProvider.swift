...
@MainActor
public protocol BackgroundServiceRestartable {
...
@MainActor
public protocol NotchServiceProvider: MediaServiceProvider, SystemServiceProvider,
    StorageServiceProvider, UIServiceProvider, PluginExtensionServiceProvider
{}

@MainActor
public protocol NotesServiceProtocol: AnyObject, Observable {
...
@MainActor
public protocol ClipboardServiceProtocol: AnyObject, Observable {
...
@MainActor
public protocol BluetoothStateServiceProtocol: AnyObject, Observable {
