...
related:
  ...
  macos_prd: docs/prds/machBrief-macOS.md
license:
  target: MIT
---
...
> **Status:** Future / planned. macOS is v1 — see `docs/prds/machBrief-macOS.md`. This document defines the iOS implementation to follow.
...
See `docs/guides/sideloading.md` for full setup guide.
