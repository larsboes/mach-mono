...
**Goal:** A configurable daily content feed. 4 slots per day (6am · 12pm · 6pm · 12am), each delivering one piece of content from the user's enabled sources. Works completely standalone — Obsidian recommended as a data sink for power users.
...
See `docs/SIDELOADING.md` for full setup guide.
