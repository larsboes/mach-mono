...
//
//  Settings are split into extensions by concern:
//    +Appearance.swift  — visual effects, glass, accent color
//    +Music.swift       — music playback, visualizer, lyrics, sneak peek
//    +Battery.swift     — battery/power indicators and notifications
//    +Notifications.swift — notification delivery, downloads
