...
struct ShelfDropService {
    static func items(
        from providers: [NSItemProvider], storage: any TemporaryFileStorageServiceProtocol
    ) async -> [ShelfItem] {
    ...
    private static func processProvider(
        _ provider: NSItemProvider, storage: any TemporaryFileStorageServiceProtocol
    ) async -> ShelfItem? {
